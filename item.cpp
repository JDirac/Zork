...
Item::Item (string inDescription, string info, Type type, int inWeightGrams, float inValue, float HP = 0, float ATK = 0, float DEF = 0) {
...
{
    if(ATK > 0) {
       return description + " " + "ATK: " + to_string(getATK()) + " " + "Value: " + to_string(getValue());
    }
    else if(DEF > 0) {
       return description + " " + "DEF: " + to_string(getDEF()) + " " + "Value: " + to_string(getValue());
    }
    else if(HP > 0) {
        return description + " " + "HP: " + to_string(getHP()) + " " + "Value: " + to_string(getValue());
    }
    return NULL;
}
